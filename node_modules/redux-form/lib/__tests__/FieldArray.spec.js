...
var describeFieldArray = function describeFieldArray(name, structure, combineReducers, expect) {
  ...
  describe(name, function () {
    ...
    it('should provide field-level sync error for array field', function () {
      ...
      var renderArray = (0, _expect.createSpy)(function (_ref3) {
    ...
    it('should provide field-level sync error (with multiple validators) for array field', function () {
      ...
      var renderArray = (0, _expect.createSpy)(function (_ref4) {
        ...
        _createClass(Form, [{
          ...
          value: function render() {
            return _react2.default.createElement(
              'div',
              null,
              _react2.default.createElement(FieldArray, { name: 'foo', component: renderArray, validate: [atLeastOne, noMoreThanTwo] })
            );
          }
        }]);
    ...
    it('should provide field-level sync warning for array field', function () {
      ...
      var renderArray = (0, _expect.createSpy)(function (_ref5) {
    ...
    it('should provide field-level sync warning (with multiple validators) for array field', function () {
      ...
      var renderArray = (0, _expect.createSpy)(function (_ref6) {
    ...
    it('should allow addition after focus', function () {
      ...
      var Form = function (_Component20) {
        ...
        function Form() {
          ...
          var _this22 = _possibleConstructorReturn(this, (Form.__proto__ || Object.getPrototypeOf(Form)).call(this));

          _this22.state = { foo: 'foo', bar: 'bar' };
          return _this22;
        }
          ...
          value: function render() {
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                'button',
                { onClick: function onClick() {
                    return _this23.setState({ foo: 'qux', bar: 'baz' });
                  } },
                'Change'
              )
            );
    ...
    it('should work with Fields', function () {
      ...
      var renderFields = (0, _expect.createSpy)(function (_ref17) {
        var foo = _ref17.foo;
        return _react2.default.createElement(
          'div',
          null,
      ...
      var component = (0, _expect.createSpy)(function (_ref18) {

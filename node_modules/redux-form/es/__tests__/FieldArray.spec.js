...
var describeFieldArray = function describeFieldArray(name, structure, combineReducers, expect) {
  ...
  describe(name, function () {
        ...
        _createClass(Form, [{
          ...
          value: function render() {
            return React.createElement(
              'div',
              null,
              React.createElement(FieldArray, { name: 'foo', component: renderArray, validate: [atLeastOne, noMoreThanTwo] })
            );
          }
        }]);
    ...
    it('should provide field-level sync warning for array field', function () {
      ...
      var renderArray = createSpy(function (_ref5) {
    ...
    it('should provide field-level sync warning (with multiple validators) for array field', function () {
      ...
      var renderArray = createSpy(function (_ref6) {
    ...
    it('should work with Fields', function () {
      ...
      var renderFields = createSpy(function (_ref17) {
        var foo = _ref17.foo;
        return React.createElement(
          'div',
          null,
      ...
      var component = createSpy(function (_ref18) {
